...
[`.agent-skills/adding-providers/references/wiring.md`](../.agent-skills/adding-providers/references/wiring.md)
...
`.agent-skills/adding-providers/` is an agent skill covering both jobs the word "provider"
