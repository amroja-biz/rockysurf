 ...
 *
 * Prices used to ship compiled into this package (`AWS_HOURLY_USD` in `prices.generated.ts`),
 ...
 *
 * NOTE: `packages/provider-azure/src/feed.ts` is this file's twin — same shape, same rules,
