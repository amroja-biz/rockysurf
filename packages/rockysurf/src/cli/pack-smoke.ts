 ...
 * it away first. Both sides of the contract say so — `docs/surge-pack-contract.md` § "The CI smoke
...
echo "  A 'runAs: rocky' script must not need root. See docs/writing-a-surge-pack.md rule 4." >&2
