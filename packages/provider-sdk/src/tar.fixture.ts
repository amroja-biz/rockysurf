...
/**
 * A ustar tarball writer, for tests only.
 *
 * `shop-entry.ts` reads npm tarballs and has to be tested against the shapes it refuses — a
 ...
 *
 * Lifted with its reader from `packages/core/src/providers/tar.fixture.ts`, deleted by #394 with
 * the in-app installer it was written for.
 *
