 ...
 *
 * NOTHING IS FETCHED UNTIL THE PAGE IS OPENED. `active` gates the first load — the Rocky Surf
 * Shop page (issue #426) passes it as soon as it mounts, and nothing else mounts this — so an
 * installation off the internet renders the section with a reason rather than hanging on it.
 *
 * WHERE THIS LIVES (issue #426, after #394). It was a fourth tab on the Surge Packs page; the
 * owner's #394 ruling took it off that page (Surge Packs is about packs; a provider is configured
 * on Settings) and pointed at the registry instead; the 2026-09-06 ruling put installing back in
 * the app, on a tab of its own. A card ends at "restart, then Settings" because ADR-0026 loads a
 * package once, before boot — nothing here pretends the provider is live.
 */
