 ...
 * (`docs/pack-contract.md` § "Building on an existing pack"; the `create-surge-pack` skill's
 ...
 *
 * SEEDED FROM `AdminSurgePack.tools`, THE ID LIST — NOT FROM EXPORT. `docs/pack-contract.md` §
