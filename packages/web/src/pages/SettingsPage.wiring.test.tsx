...
const FIELDS: SettingsField[] = (
  [
    ...
    { path: 'providers.aws.region', kind: 'string', writable: true, label: 'Region' },
    { path: 'providers.aws.profile', kind: 'string', writable: true, label: 'Profile' },
    {
    ...
    { path: 'providers.aws.securityGroupName', kind: 'string', writable: true, label: 'Security group name' },
    {
      path: 'providers.aws.sizes',
      kind: 'stringList',
      writable: false,
      label: 'Offered instance types',
      reason: 'An allowlist of instance types, edited in the file.',
    },
    { path: 'providers.azure.enabled', kind: 'boolean', writable: true },
    { path: 'providers.azure.subscriptionId', kind: 'string', writable: true, label: 'Subscription id' },
    { path: 'providers.azure.resourceGroup', kind: 'string', writable: true, label: 'Resource group' },
    { path: 'providers.azure.location', kind: 'string', writable: true, label: 'Location' },
    {
    ...
    { path: 'providers.azure.allowAllCidr', kind: 'boolean', writable: true },
    {
      ...
      kind: 'stringList',
      writable: false,
      label: 'Offered VM sizes',
      reason: 'An allowlist of VM sizes, edited in the file.',
    },
    { path: 'providers.gcp.enabled', kind: 'boolean', writable: true },
    { path: 'providers.gcp.projectId', kind: 'string', writable: true, label: 'Project id' },
    { path: 'providers.gcp.zone', kind: 'string', writable: true, label: 'Zone' },
    {
